								...
								<form action="<?= base_url('customer/proses_ubah/' . $customer->id) ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="kode_kasir"><strong>Kode Customer</strong></label>
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="username_customer" placeholder="Masukkan Username" autocomplete="off"  class="form-control" required value="<?= $customer->username_customer ?>" readonly>
										</div>
										<div class="form-group col-md-6">
											<label for="password_customer"><strong>Password</strong></label>
											<input type="text" name="password_customer" placeholder="Masukkan Password" autocomplete="off"  class="form-control" required value="<?= $customer->password_customer ?>">
										</div>
									</div>
									<hr>
