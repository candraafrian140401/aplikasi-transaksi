								...
								<form action="<?= base_url('penjualan/proses_tambah') ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										...
										<div class="form-group col-3">
											...
											<input type="text" name="kode_customer" value="<?= $this->session->login['kode'] ?>" readonly class="form-control">
										</div>
										<div class="form-group col-3">
											<label>Nama Customer</label>
											<input type="text" name="nama_customer" value="<?= $this->session->login['nama'] ?>" readonly class="form-control">
										</div>
										<div class="form-group col-2">
